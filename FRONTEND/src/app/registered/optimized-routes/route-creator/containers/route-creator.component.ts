...
import { roadNumberValidator } from 'src/app/registered/optimized-routes/route-creator/components/roadNumber.validator';
import { oddEvenChecked } from '../components/odd-even-checked.validator';
@Component({
