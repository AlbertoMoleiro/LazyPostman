...
INSERT INTO ROUTES (name, route, itinerary) VALUES ('Route A', '{"start": "Location A", "end": "Location B"}', '{"itinerary":"hola"}');
INSERT INTO ROUTES (name, route, itinerary) VALUES ('Route B', '{"start": "Location C", "end": "Location D"}', '{"itinerary":"hola"}');
INSERT INTO ROUTES (name, route, itinerary) VALUES ('Route C', '{"start": "Location E", "end": "Location F"}', '{"itinerary":"hola"}');
INSERT INTO ROUTES (name, route, itinerary) VALUES ('Route D', '{"start": "Location G", "end": "Location H"}', '{"itinerary":"hola"}');
INSERT INTO ROUTES (name, route, itinerary) VALUES ('Route E', '{"start": "Location I", "end": "Location J"}', '{"itinerary":"hola"}');
INSERT INTO ROUTES (name, route, itinerary) VALUES ('Route F', '{"start": "Location K", "end": "Location L"}', '{"itinerary":"hola"}');
INSERT INTO ROUTES (name, route, itinerary) VALUES ('Route G', '{"start": "Location M", "end": "Location N"}', '{"itinerary":"hola"}');
INSERT INTO ROUTES (name, route, itinerary) VALUES ('Route H', '{"start": "Location O", "end": "Location P"}', '{"itinerary":"hola"}');
INSERT INTO ROUTES (name, route, itinerary) VALUES ('Route I', '{"start": "Location Q", "end": "Location R"}', '{"itinerary":"hola"}');
